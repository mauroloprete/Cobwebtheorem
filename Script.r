...
GME1=GME1+theme_bw()+theme(legend.position="none")
...
MovPE1=MovPE1+theme_bw()+theme(legend.position="none")
...
GME2=GME2+theme_bw()+theme(legend.position="none")
...
MovPE2=MovPE2+theme_bw()+theme(legend.position="none")
...
GME3=GME3+theme_bw()+theme(legend.position="none")
...
MovPE3=MovPE3+theme_bw()+theme(legend.position="none")
